...
namespace MyAwardProgram.IntegrationTests.NUnit.Controllers
{
    public class UserControllerTests : IntegrationTest
    {
        ...
        [Test]
        public async Task Login_WithValidCredentials_ReturnoOkResponse()
        {
            //Arrange
        ...
        [Test]
        public async Task Login_WithInvalidCredentials_ReturnNotFoundResponse()
        {
            //Arrange
            var loginRequest = new LoginRequest
            {
        ...
        [Test]
        public async Task Create_NewUser_ReturnCreatedResponse()
        {
            //Arrange
